...
var datastoreEndpoint = "/v2/datastores/opensearch/" + dsID //nolint:gochecknoglobals
...
func TestDatastoreService_GetDatastore_Success(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		require.Equal(t, http.MethodGet, r.Method)
		require.Equal(t, "/v2/datastores/opensearch/04c5bf32-bb4b-40b4-b0c7-3cb4eb1d99d1", r.URL.Path)
